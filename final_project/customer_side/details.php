 ...
 <body>
    ...
    <?php include 'nav.php' ?>
            ...
            <?php if( isset($_SESSION['logged_in']) && $_SESSION['logged_in'] ) : ?>
                <a href="review.php?customer_id=<?php echo $_SESSION['customer_id']; ?>&menu_item_id=<?php echo $_GET['menu_item_id']; ?>" class="btn btn-primary btn-md active" role="button" aria-pressed="true">Write a Review</a>
            <?php else: ?>
                <a href="login.php" class="btn btn-primary btn-md active" role="button" aria-pressed="true">Write a Review</a>
            <?php endif; ?>
                        ...
                        <tr>
                            ...
                            <?php if(isset($_SESSION["customer_id"])&& !empty($_SESSION["customer_id"])): ?>
                                <?php if($_SESSION["customer_id"]==$row['customer_id']): ?>
                                    <a href="delete.php?customer_id=<?php echo $row['customer_id']; ?>&menu_item_id=<?php echo $row['menu_item_id']; ?>&review_id=<?php echo $row['review_id'];?>" class="btn btn-outline-danger" onclick="return confirm('You are about to delete your review');">
					Delete
                </a>
                                <?php endif; ?>
                            
                                <?php if($_SESSION["customer_id"]==$row['customer_id']): ?>
                                    <a href="update.php?review_id=<?php echo $row['review_id'];?>" class="btn btn-warning" >
					Update
                </a>
                                <?php endif; ?>
                            <?php endif; ?>
